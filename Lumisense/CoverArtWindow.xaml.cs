...
// Просмотр обложки крупно. Клик — приблизить к точке клика, зажатая ЛКМ — панорамирование,
// ПКМ — сброс к вписанному размеру; масштаб "по окну" пересчитывается при ресайзе.

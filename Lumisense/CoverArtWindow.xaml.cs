...
// много раз подряд, до разумного предела); зажатая ЛКМ с движением — панорамирование;
// ПКМ — сброс к размеру, вписанному в окно.
// Окно можно свободно растягивать, масштаб "по размеру окна" пересчитывается при ресайзе,
// пока пользователь не приблизил картинку сам.

...
public static class ChangelogDateParser
{
    ...
    // Явные форматы вместо DateTime.TryParse: с инвариантной культурой "." читалось как месяц.день,
    // и "05.07.26" молча давало 7 мая, а "13.07.26" падало в MinValue (ломало сортировку и версии).

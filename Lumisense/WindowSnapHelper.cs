...
internal static class WindowSnapHelper
{
    ...
    // Расстояние в физических пикселях до края рабочей области монитора, с которого окно "магнитится";
    // небольшое, чтобы притяжение ощущалось мягким.
    public const int SnapMarginPx = 10;

    // Прижимает прямоугольник, предложенный Windows, к краю рабочей области, если он ближе SnapMarginPx.

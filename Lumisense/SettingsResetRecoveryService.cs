...
// Точки восстановления перед явным сбросом. Не профиль для передачи: снимок содержит весь
// settings.json, поэтому хранится только в папке данных текущего пользователя.

...
// Своё окно "Свойства" для обложки трека — открывается по правому клику на обложке. Показывает
// формат, размеры, вес и откуда обложка (тег в аудиофайле, своего пути у неё нет).

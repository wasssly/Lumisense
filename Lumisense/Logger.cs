...
// Локальный файловый журнал: по сети не уходит, но может попасть в issue — персональные
// сегменты путей вырезаются. Лимиты размера защищают %AppData% от разрастания.

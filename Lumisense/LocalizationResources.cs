...
// Стабильные ключи для новых и динамических строк: в отличие от Translate("фраза"), ключ
// не ломается при редактуре текста. Миграция постепенная, старый словарь совместим.
public static class LocalizationKey
{
    ...
    public const string UpdateVelopackPlanDelivery = "update.velopack.plan.delivery";
    public const string UpdateVelopackRuntimeState = "update.velopack.runtime.state";
    public const string UpdateVelopackRuntimeReady = "update.velopack.runtime.ready";
    public const string UpdateVelopackRuntimeDownloading = "update.velopack.runtime.downloading";
    public const string UpdateVelopackRuntimePaused = "update.velopack.runtime.paused";
    public const string UpdateVelopackRuntimePreparing = "update.velopack.runtime.preparing";
    public const string UpdateVelopackRuntimeCancelled = "update.velopack.runtime.cancelled";
    public const string UpdateVelopackRuntimeFailed = "update.velopack.runtime.failed";
    public const string UpdateVelopackRuntimeProgress = "update.velopack.runtime.progress";
    public const string UpdateVelopackRuntimePausedProgress = "update.velopack.runtime.pausedProgress";
    public const string UpdateVelopackRuntimePreparedProgress = "update.velopack.runtime.preparedProgress";
    public const string UpdateVelopackRuntimeTelemetryLimit = "update.velopack.runtime.telemetryLimit";
    public const string UpdateVelopackSaveBeforeRestartFailed = "update.velopack.saveBeforeRestartFailed";
...
internal static class LocalizationResources
{
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [LocalizationKey.UpdateVelopackPlanDelivery] = "Доставка: управляемое обновление Velopack; выбор пакета и проверка целостности выполняются автоматически.",
        [LocalizationKey.UpdateVelopackRuntimeState] = "Состояние: {0}",
        [LocalizationKey.UpdateVelopackRuntimeReady] = "готово к загрузке",
        [LocalizationKey.UpdateVelopackRuntimeDownloading] = "скачивание и проверка пакетов",
        [LocalizationKey.UpdateVelopackRuntimePaused] = "приостановлено",
        [LocalizationKey.UpdateVelopackRuntimePreparing] = "подготовка перезапуска",
        [LocalizationKey.UpdateVelopackRuntimeCancelled] = "отменено",
        [LocalizationKey.UpdateVelopackRuntimeFailed] = "не удалось подготовить обновление",
        [LocalizationKey.UpdateVelopackRuntimeProgress] = "Ход: {0}% · прошло {1}",
        [LocalizationKey.UpdateVelopackRuntimePausedProgress] = "Ход: приостановлено на {0}% · прошло {1}",
        [LocalizationKey.UpdateVelopackRuntimePreparedProgress] = "Ход: пакет подготовлен · прошло {0}",
        [LocalizationKey.UpdateVelopackRuntimeTelemetryLimit] = "Точно переданные байты, скорость и фактически выбранный full/delta-пакет публичный API Velopack не сообщает.",
        [LocalizationKey.UpdateVelopackSaveBeforeRestartFailed] = "Не удалось подтвердить сохранение текущих настроек перед перезапуском. Обновление не применено; закройте окно и повторите попытку.",
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [LocalizationKey.UpdateVelopackPlanDelivery] = "Delivery: managed Velopack update; package selection and integrity verification are performed automatically.",
        [LocalizationKey.UpdateVelopackRuntimeState] = "State: {0}",
        [LocalizationKey.UpdateVelopackRuntimeReady] = "ready to download",
        [LocalizationKey.UpdateVelopackRuntimeDownloading] = "downloading and verifying packages",
        [LocalizationKey.UpdateVelopackRuntimePaused] = "paused",
        [LocalizationKey.UpdateVelopackRuntimePreparing] = "preparing restart",
        [LocalizationKey.UpdateVelopackRuntimeCancelled] = "cancelled",
        [LocalizationKey.UpdateVelopackRuntimeFailed] = "the update could not be prepared",
        [LocalizationKey.UpdateVelopackRuntimeProgress] = "Progress: {0}% · elapsed {1}",
        [LocalizationKey.UpdateVelopackRuntimePausedProgress] = "Progress: paused at {0}% · elapsed {1}",
        [LocalizationKey.UpdateVelopackRuntimePreparedProgress] = "Progress: package prepared · elapsed {0}",
        [LocalizationKey.UpdateVelopackRuntimeTelemetryLimit] = "The public Velopack API does not report actual transferred bytes, speed, or the full/delta package selected at runtime.",
        [LocalizationKey.UpdateVelopackSaveBeforeRestartFailed] = "Current settings could not be confirmed as saved before restart. The update was not applied; close this window and try again.",

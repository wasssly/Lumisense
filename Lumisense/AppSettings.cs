...
public class AppSettings
{
    ...
    // открываются и закрываются слишком быстро, чтобы разница была заметна, а держать в
    // актуальном состоянии подложку у полутора десятков разных окон ради этого не стоит усилий.

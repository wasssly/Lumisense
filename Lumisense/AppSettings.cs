...
public class AppSettings
{
    ...
    // Скрывает кнопки "Перемешать", "Повтор", "Предыдущий", "Пуск/Пауза", "Следующий", "Стоп"
    // и переход в мини-плеер в главном окне (см. MainWindow.ApplyPlaybackButtonsVisibility) —
    // вся панель управления воспроизведением становится пустой полосой без кнопок.

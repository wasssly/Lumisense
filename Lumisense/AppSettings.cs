...
public class AppSettings
{
    ...
    // Скрывает кнопки "Перемешать", "Повтор", "Предыдущий", "Пуск/Пауза" и "Следующий" в
    // главном окне (см. MainWindow.ApplyPlaybackButtonsVisibility) — сама панель управления
    // становится пустой полосой без кнопок. Кнопка "Стоп" не входит в этот набор намеренно:
    // пользователь просил скрыть именно эти пять, а не всю панель целиком.

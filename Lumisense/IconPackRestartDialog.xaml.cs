...
public partial class IconPackRestartDialog : Window
{
    private readonly AppSettings _settings;

    public IconPackRestartDialog(Window owner, AppSettings settings)
    {
        InitializeComponent();
        Owner = owner;
        _settings = settings;
    ...
    {
        // Фиксируем выбранный пак иконок до запуска новой копии, чтобы после перезапуска
        // приложение сразу использовало актуальный набор.

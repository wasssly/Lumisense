...
// Локализация интерфейса без правки XAML: статические русские подписи собраны в словарь и
// переводятся на уровне визуального дерева, чтобы не ломать стили WPF-UI и привязки данных.
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> EnglishByRussian = new(StringComparer.Ordinal)
    {
        ...
        ["Выравнивание — в свободном месте карточки рядом с обложкой."] = "Alignment applies to the space in the card next to the cover art.",
        ["Ширина"] = "Width",
        ["Монитор"] = "Monitor",
        ...
        ["Сохранить обработанную копию"] = "Save processed copy",
        ["MP3-файл (*.mp3)|*.mp3"] = "MP3 file (*.mp3)|*.mp3",
        ["Копия должна сохраняться в отдельный MP3-файл."] = "The copy must be saved as a separate MP3 file.",
        ["Сохранение копии"] = "Saving copy",
        ["Файл с таким именем уже существует. Выберите другое имя, чтобы не перезаписывать его."] = "A file with this name already exists. Choose a different name to avoid overwriting it.",
        ["Файл уже существует"] = "File already exists",
        ["Копия сохранена:\\n{dialog.FileName}"] = "Copy saved:\\n{dialog.FileName}",
        ["Сохранение завершено"] = "Save complete",
        ["Не удалось сохранить MP3-копию:\\n{ex.Message}"] = "Failed to save MP3 copy:\\n{ex.Message}",
        ...
        ["Режим WASAPI"] = "WASAPI mode",
        ["Общий (Shared)"] = "Shared",
        ["Монопольный (Exclusive)"] = "Exclusive",
        ["Монопольный режим отдаёт устройство целиком Lumisense — другие приложения на время воспроизведения теряют звук на этом устройстве. Поддерживается не всеми звуковыми картами: если устройство откажется работать в этом режиме, Lumisense автоматически вернётся к общему."] = "Exclusive mode gives the device entirely to Lumisense — other applications lose sound on this device while a track is playing. Not every sound card supports it: if the device refuses this mode, Lumisense automatically falls back to shared.",
        ["Не удалось открыть устройство в монопольном режиме WASAPI. Lumisense переключился на общий режим."] = "The device could not be opened in exclusive WASAPI mode. Lumisense switched to shared mode.",
